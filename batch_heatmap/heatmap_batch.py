...
def grid_probability_evaluation(dimension, time_lb, time_up, time_sampling_points, beta_lb, beta_up, beta_sampling_points):
    ...
    minutes = time.perf_counter() - tic

    file_probability = str(dimension) + '_probability_2nd.npy'
    file_adiabatic_check = str(dimension) + '_adiabatic_check_2nd.npy'
    file_time_array = str(dimension) + '_time_array_2nd.npy'
    file_beta_array = str(dimension) + '_beta_array_2nd.npy'
    ...
    return print('Dimension ', dimension, ' successfully saved to .npy in ', (minutes), ' minutes')
...
dimension = 11
grid_probability_evaluation(dimension, 1,70,40, 0, 6, 30)
