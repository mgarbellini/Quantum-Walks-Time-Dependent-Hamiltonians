...
\end{equation}
where $L$ is the laplacian described in Section II and $|w\rangle$ is the oracle state, i.e. the target. 
...
On the other hand we know that for our algorithm to be somewhat interesting from the perspective of the quantum search itxs
