...
def parallel_routine():
    ...
    time_0 = time_2 - float(dimension/24)*2
    time_1 = time_2 - float(dimension/24)
    time_3 = time_2 + float(dimension/24)
    time_4 = time_2 + float(dimension/24)*2

    if(type_of_qw == 'independent'):
        time_0 = time_2 - float(dimension/24)*4
        time_1 = time_2 - float(dimension/24)*2
        time_3 = time_2 + float(dimension/24)*2
        time_4 = time_2 + float(dimension/24)*4

    time_array = [time_0, time_1, time_2, time_3, time_4]
    process = []
    probability = []
    ...
    file_probability = 'FIG14_' + str(dimension) + '_probability_' + step_function + '.npy'
    file_time = 'FIG14_' + str(dimension) + '_circ_time.npy'
    file_beta = 'FIG14_' + str(dimension) + '_circ_beta.npy'
...
if __name__ == '__main__':
    ...
    rtolerance = 1e-6
    atolerance = 1e-6
    step_functions = ['static','lin', 'cerf_3']
